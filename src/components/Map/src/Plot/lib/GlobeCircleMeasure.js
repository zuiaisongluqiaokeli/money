...
var GlobeCircleMeasure = function() {
  this.init.apply(this, arguments);
};

GlobeCircleMeasure.prototype = {
  viewer: null,
  scene: null,
  clock: null,
  canvas: null,
  ...
  _showRegion2Map: function() {
    ...
    if (_this.extrudedHeight > 0) {
      ...
      bData.polygon.extrudedHeightReference =
  ...
  CLASS_NAME: "GlobeCircleMeasure",
};

export default GlobeCircleMeasure;
