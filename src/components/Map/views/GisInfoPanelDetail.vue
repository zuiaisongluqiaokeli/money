<template>
    <div class="GisInfoPanel" :class="[show ? 'show-panel' : 'hide-panel']">
                    ...
                    查看详细
                        ...
                        <el-collapse-item name="3" title="标签">
                            <div class="labels collapse-body">
                                <div v-if="newVerticesData.labelsList.length > 0" style="width: 100%; font-size: 14px">
                            ...
                            <div class="labels collapse-body">
                                <div v-if="fileData.length > 0" style="width: 96%; font-size: 14px">
                                    <div v-for="(item, index) in fileData" :key="index" class="list-item" :title="item.name">
                                        <div>
                                            <span :class="item.icon" class="file-icon"></span><span class="file-name">{{ item.name }}</span>
                                        </div>
        ...
        <!-- 查看详细内容弹窗 -->
        <el-dialog append-to-body class="map-info-panel-dialog detail-dialog" :title="detailDialogTitle" :visible.sync="detailDialogVisible" width="500px">
            <el-form class="dialog-form" label-width="40px" v-if="
        ...
        ">
            ...
            <el-radio-group v-model="checkedRadio" v-if="detailDialogTitle == '隶属'">
                <el-radio v-for="(item, index) in radioData" :label="item.id" :key="index" class="radio">
                    {{ item.name }}
                </el-radio>
            </el-radio-group>
        </el-dialog>
