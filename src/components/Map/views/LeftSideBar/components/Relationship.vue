<template>
    <div id="editConnectionModal">
        <el-dialog title="关联" :close-on-click-modal="false" :visible="dialogVisible" @close="closeDialog" v-loading="loading" append-to-body class="edit-connection-modal">
            <!-- form -->
            <el-form ref="form" class="form" label-width="100px">
                    ...
                    <el-form-item label="实体关系">
                        <div class="relation">
                            <div class="img-wrap">
                                ...
                                <div class="name-text" :title="selectedVertices[0] && selectedVertices[0].name">
                                    {{ selectedVertices[0] && selectedVertices[0].name }}
                                </div>
                            </div>
                            <div class="center">
                                <div class="rect triangle border hidden left" :class="{ 'is-active': addFormData.direction[0] }" @click="setDirectionByClick(0)"></div>
                                <div class="line"></div>
                                <div class="rect triangle border hidden right" :class="{ 'is-active': addFormData.direction[1] }" @click="setDirectionByClick(1)"></div>
                                <div class="input">
                            ...
                            <div class="img-wrap">
                                ...
                                <div class="name-text" :title="selectedVertices[1] && selectedVertices[1].name">
                ...
                <div class="edit" v-if="type === 'edit'">
                    <el-form-item label="关系方向">
                        <div class="relation-direction">
                            <el-select v-model="editFormData.currentDirection" placeholder="请选择方向" @change="handleDirectionChange">
                                <el-option value="forward" label="正向"></el-option>
                                <el-option value="reverse" label="反向"></el-option>
                            </el-select>
                            <el-form-item label="关系名称">
                                <el-select v-model="editFormData.currentRelationName" value-key="id" placeholder="请选择名称" @change="handleRelationNameChange">
                                    <el-option v-for="(item,
                    index) in editFormData.currentRelationNameList" :key="index" :value="item" :label="item.type">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                        </div>
                    ...
                    <el-form-item label="实体关系">
                        <div class="relation">
                            ...
                            <div class="center" v-if="showCenter">
                                <div class="rect triangle hidden left" :class="{ 'is-active': editFormData.direction[0] }"></div>
                                <div class="line"></div>
                                <div class="rect triangle hidden right" :class="{ 'is-active': editFormData.direction[1] }"></div>
                                <div class="input">
                ...
                <div class="delete" v-if="type === 'delete'">
                    <el-form-item label="关系方向">
                        <div class="relation-direction">
                            <el-select v-model="deleteFormData.currentDirection" placeholder="请选择方向" @change="handleDirectionChange">
                                <el-option value="forward" label="正向"></el-option>
                                <el-option value="reverse" label="反向"></el-option>
                            </el-select>
                            <el-form-item label="关系名称">
                                <el-select v-model="deleteFormData.currentRelationName" value-key="id" placeholder="请选择名称" @change="handleRelationNameChange">
                                    <el-option v-for="(item,
                    index) in deleteFormData.currentRelationNameList" :value="item" :label="item.type" :key="index"></el-option>
                                </el-select>
                            </el-form-item>
                        </div>
                    </el-form-item>
                    <el-form-item label="实体关系">
                        <div class="relation">
                            ...
                            <div class="center" v-if="showCenter">
                                <div class="rect triangle hidden left" :class="{ 'is-active': deleteFormData.direction[0] }"></div>
                                <div class="line"></div>
                                <div class="rect triangle hidden right" :class="{ 'is-active': deleteFormData.direction[1] }"></div>
        ...
        async saveDialog() {
            ...
            if (!res.data.success) {
                ...
                if (!res && !res.data.object) {
                    ...
                    // let arr = [].concat(this.selectedVertices[0],this.selectedVertices[1])
                    // this.setallRelationData(this.selectedVertices)
                    //对数据划分哪个是起点哪个是终点
                    let center = {
