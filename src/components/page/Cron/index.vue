<template lang="html">
  <div class="cron" :val="value_">
    <el-button type="primary" style="position: absolute;z-index: 999;cursor: pointer;right: 1%;" @click="confirmResults">确定结果</el-button>
...
<script>
import SecondAndMinute from './cronComponent/secondAndMinute';
import hour from './cronComponent/hour';
import day from './cronComponent/day';
import month from './cronComponent/month';
import week from './cronComponent/week';
import year from './cronComponent/year';
export default {
    props: {
        value: {
            type: String
