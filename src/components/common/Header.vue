            ...
            <div class="header-user-con">
                ...
                <el-dropdown class="user-name" @command="handleCommand" :hide-timeout="500">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <a href="https://github.com/zuiaisongluqiaokeli" target="_blank">
                            <el-dropdown-item>项目仓库</el-dropdown-item>
                        </a>
                        <el-dropdown-item divided command="loginin" :disabled="loginState">每日签到</el-dropdown-item>
