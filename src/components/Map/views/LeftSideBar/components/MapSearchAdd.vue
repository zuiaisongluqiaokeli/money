          ...
          <el-col :span="11" class="col">
            <div class="wrap">
              ...
              <div class="content">
                <MapCategory
                  class="map-category"
                  :click-method="handleCategoryClick"
                />
              </div>
            </div>
          </el-col>
          ...
          <el-row class="current-selected">
            <el-col :span="11">
              ...
              <i
                ...
                @click="cancelSelected('treeSelected')"
              >
              </i>
            </el-col>
            <el-col :span="11" :offset="2">
              ...
              <i
                class="el-icon-delete delete"
                @click="cancelSelected('markSelected')"
              >
              </i>
            </el-col>
          </el-row>
...
import mapSearchAddCategoryJson from "../../../mock/map-search-add-category.json";
import mapSearchAddGroupJson from "../../../mock/map-search-add-group.json";
...
export default {
  ...
  methods: {
    ...
    async knowledgeEquipmentSearch(group, type, country) {
      ...
      const res = await knowledgeEquipmentSearch(
        graphName,
        group,
        type,
        country
      ...
      // const { success, object, msg } = mapSearchAddGroupJson;
    ...
    async searchAndAdd() {
      ...
      if (result) {
        ...
        const data = group
          ...
          : processCategoryData(result, { flat: true });
