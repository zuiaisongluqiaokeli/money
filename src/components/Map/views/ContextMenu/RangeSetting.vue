<template>
    <div class="RangeSetting">
        <el-dialog title="设置" visible width="400px" :modal="false" :before-close="cancel">
            <el-form label-width="80px">
                ...
                <el-form-item label="标签">
                    <el-select v-model="labels" multiple collapse-tags filterable :filter-method="filterMethod">
                        <el-option v-for="val in allLabels" :label="val" :key="val" :value="val"></el-option>
                    </el-select>
                </el-form-item>
            </el-form>
...
export default {
    ...
    computed: {
        ...mapState('map', ['rangeSetting', 'gisRightSelectedEntity', 'gisEntities', 'gisLabelShow']),
    ...
    methods: {
        ...
        ...mapMutations('map', ['setRangeSetting', 'updateGisEntities', 'changeGisRightSelectedEntity']),
